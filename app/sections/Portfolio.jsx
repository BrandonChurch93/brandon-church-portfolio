...
const Portfolio = () => {
  ...
  const projects = [
    ...
    {
      id: "coming-soon-1",
      title: "AI-Enhanced Developer Tool",
      tagline: "Streamline your development workflow",
      description:
        "Revolutionary tool that brings AI directly into your development environment.",
      image: "/images/placeholder.png",
      techStack: ["Next.js", "AI/ML", "Node.js"],
      status: "coming-soon",
    },
    {
      id: "coming-soon-2",
      title: "Intelligent User Interface",
      tagline: "Adaptive UI that learns from users",
      description:
        "Next-generation interface that adapts to user behavior and preferences in real-time.",
      image: "/images/placeholder.png",
    ...
    {
      id: "coming-soon-3",
      title: "Next-Gen Web Experience",
      tagline: "Pushing the boundaries of web interaction",
      description:
        "An immersive web experience combining cutting-edge technologies.",
      image: "/images/placeholder.png",
      techStack: ["Three.js", "WebXR", "AI"],
      status: "coming-soon",
    },
  ];
