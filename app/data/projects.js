export const projects = [
  ...
  },
  {
    ...
    cardDescription:
      "An interactive SVG arc-animation builder. 36 live controls across line, five glow layers, entrance, and breathing motion, rendered instantly on a staged fintech site. Every design is shareable as a URL.",
    featured: false,
    ...
    githubLabel: "View Code",
    cardTechStack: ["Next.js 16", "React 19", "TypeScript", "SVG", "CSS 3D"],
    techStack: [
      "Next.js 16",
      "React 19",
      "TypeScript",
    ...
    metrics: [
      ...
      { value: "6", label: "Runtime dependencies" },
    ],
    description:
    ...
    features: [
      ...
      "Six runtime dependencies total; the animation system, the contrast engine, and the 3D interaction are all hand-built",
    ],
  },
  {
    slug: "codepen",
